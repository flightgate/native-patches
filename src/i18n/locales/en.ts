...
export const en = {
  errors: {
    ...
    failedToApplyByTarget: `{error} Failed to apply %{target} patches`,
    failedToRunStep: `{error} Failed to run step: %{step}`,
  },
  warnings: {
    hasChanges: [
  ...
  success: {
    ...
    generate: {
      ...
      one: [`{success} Patch created successfully`, nextSteps].join('\n'),
      other: [`{success} Patches created successfully`, nextSteps].join('\n'),
    },
    apply: {
